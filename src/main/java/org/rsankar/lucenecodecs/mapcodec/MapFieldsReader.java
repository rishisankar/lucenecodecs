...
public class MapFieldsReader extends FieldsProducer {
	...
	public Terms terms(String field) throws IOException {
		...
		if (terms == null) {
			String fileName = MapPostingsFormat.getFieldMapFileName(segmentName,
					state.segmentSuffix);
			try {
				IndexInput in = this.state.directory.openInput(fileName,
						state.context);
	...
	public void checkIntegrity() throws IOException {
		throw new RuntimeException(
				"checkIntegrity() called in MapFieldsReader");
	}
	...
	private class MapTerms extends Terms {
		...
		public String toString() {
			return getClass().getSimpleName() + "(terms=" + termCount
					+ ",postings=" + sumDocFreq + ",positions="
	...
	private class MapTermsEnum extends BaseTermsEnum {
		...
		public BytesRef next() throws IOException {
			throw new RuntimeException(
					"next() called in MapFieldsReader.MapTermsEnum");
		}

		@Override
		public SeekStatus seekCeil(BytesRef text) throws IOException {
			throw new RuntimeException(
					"seekCeil() called in MapFieldsReader.MapTermsEnum");
		}

		@Override
		public long ord() throws IOException {
			throw new RuntimeException(
					"ord() called in MapFieldsReader.MapTermsEnum");
		}
		@Override
		public void seekExact(long ord) throws IOException {
			throw new RuntimeException(
					"seexExact(long ord) called in MapFieldsReader.MapTermsEnum");
		}
	}
